    ...
    initExtras: function() {
        ...
        function a(m) {
            if (m == "initials") {
                ...
                $("input[name='embroidery_price']").val(l);
                if (n != "") {
        ...
        function e(m, n) {
            ...
            $("#lining_default_jacket").click(function() {
            	...
            	lining_id_set.val('');
                $("#lining_box_jacket").hide();
                window.coat_price.lining_jacket = 0 ;
            ...
            $("#inp_lining_personalized_jacket, div.deco_lining").click(function() {
                ...
                n.show();
                price = window.t4l_linings.jacket['price'];
                window.coat_price.lining_jacket = price;
                $("input[name='lining_jacket_price']").val(price);
                ...
                $("div#lining_box_jacket div.preview").css("background", "url("+Man_Coat.url+ l_id + ") top right no-repeat")
            ...
            $("a.select").click(function() {
                    ...
                    $(this).closest("div.lining_3d").find(".preview_fabric_3d_common div.preview").css("background", "url("+Man_Coat.url+ v + ") top right no-repeat");
        ...
        $("input.thread_holes_selector").on("click load",function(event) {
          ...
          if(btn_thread_type=='both_opt') {
            ...
            $("input[name='button_holes_threads_price']").val(window.extra_prices.btn_holes_threads);
            ...
            $("input[name='placket_color']").val('');
            window.coat_price["button_holes_threads_jacket"] = 0;
            $("input[name='button_holes_threads_price']").val('');
          }
        ...
        $("input.default_item").click(function() {
            var type=$(this).val();
            if(type=="embroidery_no")
            {
                $("input[name='embroidery_price']").val('');
                window.coat_price.initials=0;  
            }
            if(type=="standard_button")
              window.extra_prices.metal_buttons=0;
            if(type=="color_by_default")
            {
                $("input[name='neck_lining_price']").val('');
              window.coat_price.neck_lining=0;
            }
            if(type=="elbow_no")
        ...
        $("input.personalized_item").click(function() {
            name = $(this).attr("extra_name");
            if(name=="embroidery")
            {   
                window.coat_price.initials = $("#extra_form .box_title.initials a.btn_cancel_add").attr("price");
                $("input[name='embroidery_price']").val(window.coat_price.initials);
                Man_Coat.updatePrice();
            }
