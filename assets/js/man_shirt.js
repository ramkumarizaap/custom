var Man_Shirt = {
    ...
    initCommon: function() {
        ...
        window.shirt_price.initials_jacket= window.shirt_price.initials_jacket;
    ...
    initExtras: function(def2) {
        ...
        $("#txt_initial_jacket").on('keyup', function() {
            $("label[layer='monogram']:nth-child(1)").removeClass('checked');
            $("label[layer='monogram']:nth-child(2)").addClass('checked');
        ...
        $(".collar_inner_fabric,.collar_outer_fabric").click(function(){
            $("div[rel='neck_lining'] .option_trigger:first a.box_color").trigger('click');
        });
        $(".cuff_inner_fabric,.cuff_outer_fabric").click(function(){
            $("div[rel='handkerchief'] .option_trigger:first a.box_color").trigger('click');
        });
        $("#extra_form div.list_common_color a.box_color").click(function() {
            ...
            if(j=="monogram_color") 
            {
                // alert(window.shirt_price.initials_jacket);
            ...
            if(j=="cuff_color") {
                price1 = $(".cuff_col").attr("price");
                 $("input[name='cuff_color']").val(n);
                 $("input[name='handkerchief_price']").val(price1);
                 if(price1!=undefined)
        ...
        $("input.personalized_item").click(function() {
            val = $(this).val();
            var n = $(this).attr("extra_name");
            var price = $(this).attr("price");
            if(n=="monogram")
                window.shirt_price.initials_jacket = price;
            Man_Shirt.updatePrice();
        });
        ...
        $("a.color_item").click(function() {
            ...
            if(s=='jacket_patches') {
                ...
                $("input[name='patches_price']").val(window.shirt_price.patches_jacket);
