var Man_Suit = {
    ...
    initCommon: function(b, f, d, e, a, g, c, h,z) {
        ...
        // window.suit_price.embroidery= window.suit_price.extra_prices.embroidery_design;
    ...
    updatePrice: function() {
      ...
      if(r=="extras" || r=="fabric" || r=="configure") {
        $.ajax({
            type:"POST",
            async:false,
            url: "http://localhost/custom/includes/action/price_update.php",
    ...
    initExtrasWaistcoat: function() {
        ...
        function m(q, u) {
            ...
            q.find("div.slider_fabrics").load(base_href + "extras?product_type=man_waistcoat&action=filter", s, function(v) {
                $("a.select", this).click(function() {
                    ...
                    $(this).closest("div.lining_3d").find(".preview_fabric_3d_common div.preview").css("background", "url("+Man_Suit.url+ y + ") top right no-repeat");
        ...
        function h(p, q, s, r) {
            ...
            $("#inp_lining_personalized_waistcoat, div.deco_lining", p).click(function() {
                ...
                $("div.preview", p).css("background", "url("+Man_Suit.url+ o.val() + ") top right no-repeat");
                g()
            });
            ...
            $("#inp_lining_back_personalized, div.deco_lining", q).click(function() {
                ...
                i($("input#input_hidden_lining_back", a).val());
                g();
                $("div#lining_box_back div.preview").css("background", "url("+Man_Suit.url+ t.val() + ") top right no-repeat");
                Man_Suit.showCloths("parcial_suit3")
            });
        ...
        if ($("#inp_lining_personalized_waistcoat:checked", a).length) {
            ...
            $("div#lining_box_waistcoat div.preview").css("background", "url("+Man_Suit.url + n + ") top right no-repeat")
        }
        if ($("#inp_lining_back_personalized:checked", a).length) {
            e.show();
            $("div.deco_lining").hide();
            var n = $("#input_hidden_lining_back", a).val();
            $("div#lining_box_back div.preview").css("background", "url("+Man_Suit.url+ n + ") top right no-repeat")
        }
        k();
        g()
    },
    initExtrasJacket: function() {
        ...
        $("input.thread_holes_selector", e).on("click load",function(event) {
          ...
          if(btn_thread_type=='lapel') {

            $("#lapel_jacket_button").hide();
            $("#button_thread_type").show();
            $("#placket_only").show();
            $("#jacket_only").hide();
            $("#cuffs_only").hide();
            $("#first_sleeve_only").hide();
            window.suit_price["button_holes_threads_jacket"] = window.extra_prices.btn_holes_threads;

          }
          else if(btn_thread_type=='lapel_jacket_button') {
            $("#button_thread_type").hide();
            $("#jacket_only").hide();
            $("#placket_only").hide();
            $("#lapel_jacket_button").show();
            $("#first_sleeve_only").hide();
            $("#cuffs_only").hide();
          ...
          else if(btn_thread_type=='first_sleeve_jacket') {
            $("#lapel_jacket_button").hide();
             $("#button_thread_type").show();
            $("#placket_only").hide();
            $("#cuffs_only").show();
            $("#jacket_only").show();
            $("#cuffs_only .button-threads").hide();
            $("#cuffs_only #box_button_threads_extra").css("display","none !important");
            $("#first_sleeve_only").hide();
           ...
           else if(btn_thread_type=='first_sleeve') {
            $("#lapel_jacket_button").hide();
            $("#button_thread_type").hide();
            $("#cuffs_only").hide();
            $("#first_sleeve_only").show();
            $("#jacket_only").hide();
            $("#placket_only").hide();
            $("input[name='placket_color']").val('');
            window.suit_price["button_holes_threads_jacket"] = window.extra_prices.btn_holes_threads;
          }
            else if(btn_thread_type=='first_button') {
                $("#lapel_jacket_button").hide();
             $("#button_thread_type").show();
            $("#placket_only").hide();$("#jacket_only").show();
            $("#cuffs_only").hide();
            $("#first_sleeve_only").hide();
            $("input[name='placket_color']").val('');
            window.suit_price["button_holes_threads_jacket"] = window.extra_prices.btn_holes_threads;
          }
         else if(btn_thread_type=='lapel_jakcet_sleeves') {
                $("#lapel_jacket_button").hide();
                $("#lapel_jacket_button").show();
             $("#button_thread_type").show();
            $("#placket_only").hide();$("#jacket_only").hide();
            $("#cuffs_only").hide();
            $("#first_sleeve_only").show();
            $("input[name='placket_color']").val('');
            window.suit_price["button_holes_threads_jacket"] = window.extra_prices.btn_holes_threads;
            ...
            $("#button_thread_type").hide();$("#placket_only").hide();$("#jacket_only").hide();
             $("#first_sleeve_only").hide();$("#cuffs_only").hide();
             $("#lapel_jacket_button").hide();
            $("input[name='button_holes_threads_jacket1']").val('');
            $("input[name='button_holes_threads_jacket1']").val('');
            $("input[name='placket_color']").val('');
          ...
          // alert(5);
            ...
            if (m.hasClass("open")) {
                ...
                if (l == "initials") {
                    ...
                    window.suit_price["embroidery"] = 0;
        ...
        $("a.color_item").click(function() {
            ...
            else if(n.attr("extra_name") == "embroidery") {
                // var price= window.extra_prices.pocket_square;
                // alert();
            }
        ...
        $("input[name='embroidery_type']").click(function(){
          val = $(this).val();
          if(val=="embroidery_no")
            var price = 0;
          else
            var price = window.extra_prices.embroidery_design;
          window.suit_price['embroidery'] = price;
          Man_Suit.updatePrice();
        });
        ...
        $("#txt_initial_jacket", e).on('keyup', function() {
            d();
            $("label[layer='embroidery']:nth-child(1)").removeClass('checked');
            $("label[layer='embroidery']:nth-child(2)").addClass('checked');
            $("#inp_embroidery_personalized").prop('checked',true);
            Man_Suit.cloth_open = false;
            var event_type=true;
            a("initials_jacket");
        });
        ...
        function j(n, r) {
            ...
            $("a.select").click(function() {
                    ...
                    $(this).closest("div.lining_3d").find(".preview_fabric_3d_common div.preview").css("background", "url("+Man_Suit.url+ v + ") top right no-repeat");
        ...
        function g(m, n) {
            ...
            $("#inp_lining_personalized_jacket, div.deco_lining").click(function() {
                ...
                Man_Suit.lining_radio = "";
                f();
                $("div#lining_box_jacket div.preview").css("background", "url("+Man_Suit.url+ l.val() + ") top right no-repeat");
                //lining_price_set.val(lining_price);
                Man_Suit.cloth_open = false;
                Man_Suit.render.jacket_opened = false;
                //Man_Suit.redraw(true)
        ...
        function f() {
            ...
            if (Man_Suit.lining_radio == "unlined") {
                ...
                if (Man_Suit.current_id_t4l_lining == Man_Suit.default_id_t4l_lining && $("input[name='default_jacket_val']").val()=='yes') {
                    ...
                    m = window.t4l_linings.jacket["price"];
                    // alert(Man_Suit.current_id_t4l_lining);
                    // alert(m);
                    // alert(2);
        ...
        if ($("#inp_lining_personalized_jacket:checked").length) {
            ...
            $("div#lining_box_jacket div.preview").css("background", "url("+Man_Suit.url+ k + ") top right no-repeat")
        }
