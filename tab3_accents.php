...
{ 
  ...
  if(mysqli_num_rows($fab_dtl_qry) > 0)
  {
    ...
    {
      $_SESSION['fab_dtl'] = array('fab_id' =>$fr['fab_rand'],'fab_unique_id' => $fr['fab_id'],'fab_name' => $fr['fab_name'],
        'fab_desc' => $fr['fab_desc'],'fab_img' => $fr['fab_img'],'fab_price' => $fr['fab_price'],'fab_default_img' => $fr['default_img']);
    }
  }
  ?>
  <div class="wrapper">
    ...
    <div class="full-width section-emphasis-1 page-header">
      <div class="container">
        <header class="row">
          <div class="col-md-12">
            <h1 class=" pull-left"><?php echo $_SESSION['p_dtl']['sub_category']; ?></h1>
            <!-- BREADCRUMBS -->
              <ul class="breadcrumbs list-inline pull-right">
                <li><a href="<?php echo $homeurl;?>">Home</a></li>
                <li><a href="<?php echo $homeurl;?>Shop/<?php echo strtolower(str_replace(' ','-',$_SESSION['p_dtl']['category'])); ?>/ <?php echo strtolower(str_replace(' ','-',$_SESSION['p_dtl']['sub_category'])); ?>/">
                  <?php echo $_SESSION['p_dtl']['sub_category']; ?></a>
                </li>
                <li>Customize</li>
              </ul>
              <!-- !BREADCRUMBS -->
                  ...
                  <div class="row">
                    <div class="col-xs-7">
                      <ul class="nav nav-tabs">
                        <li><a href="#" id="link_configure" class="tab">Style</a></li>
                        <li><a href="#" class="tab" id="link_fabric">Fabric</a></li>
                        <li class="active"><a href="#" class="tab" id="link_extras">Accents</a></li>
                      </ul>
                      <div class="c-nav cf" id="extra_forms">
                        <a href="javascript:;" class="next step_next btn btn-default pull-right">NEXT STEP</a>
                        <a href="javascript:;" class="step_prev btn btn-default pull-right">PREVIOUS</a>
                        <span id="price_img" class="garment_price btn btn-default pull-right"><small>$</small>
                        ...
                        <form method="post" id="extra_form" action="<?php echo $homeurl; ?>includes/action/action.php" class="configure_form man_waistcoat man_jacket man_suit">
                            ...
                            <div id="move">
                              <div id="control_suit">
                                ...
                                <div id="box_change_position">
                                  <a id="change_position" class="change_position" href="javascript:;" rel="front">Turn around model</a>
                                </div>
                                <!-- Show or hide jacket -->
                                <div id="show_hide_pieces" class="full">
                                  <a href="javascript:;" class="show_full_parcial" rel="parcial_suit2"><span class="full">Show jacket</span><span class="parcial">Hide jacket</span></a>
                                </div>
                              </div>
                              <!-- MODEL 3D -->
                              <div id="loading"></div>
                              <div class="col-md-12">
                                <div class="controls col-md-1">
                                  <a data-icon="O" class="icon zoom in" href="javascript:;" style="display: block;"><span class="h">ZOOM</span></a><a data-icon="P" class="icon zoom out" href="javascript:;" style="display: none;"><span class="h">ZOOM</span></a>
                                </div>
                                <div id="model_3d_preview" class="man_suit col-md-11" style="position: relative;"></div>  
                              </div>
                              <div id="model_3d_preview1" class="man_suit"></div>
                              <!-- CONTROLS -->
                          ...
                          <div class="opt_box">
                            <div class="content extras_suit suit" id="max_height_move">
                              <!-- TITLE -->
                              <!--<div class="box_title"><h1 class="title">Custom suits &nbsp;/</h1><span class="subtitle">&nbsp;Step 3:
                                <span>Add your personal touch</span></span>
                              </div>-->
                              <br style="clear: both;"/>
                                ...
                                <ul id="box_tab_suit_view" class="jacket">
                                  <li class="jacket">
                                    <a id="tab_default_fabric" rel="default" href="javascript:;" class="jacket">
                                      <span>Customize jacket & pants</span>
                                    </a>
                                  </li>
                                  <li class="waistcoat"><a class="waistcoat" rel="waistcoat" href="javascript:;"><span>Customize Vest</span></a>
                                  </li>
                                </ul>
                                <!-- EXTRAS JACKET -->
                                <div id="extras_jacket">
                                  ...
                                  <div class="extra_opt extra_3d lining_opt extra_title">
                                    <div class="box_title box_title_new open lining_jacket main">
                                      ...
                                      <p class="name">Select Jacket Lining 
                                        <span>
                                          <?=($acc_price['jacket_lining_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['jacket_lining_price'])."$)";?>
                                        </span>
                                        <a href="javascript:;" class="btn_cancel_add" rel="lining_jacket" price="<?=$acc_price['jacket_lining_price'];?>">Delete</a>
                                      </p>
                                    </div>
                                    <div id="options_lining_jacket" class="window lining top" style="display: block;">
                                      ...
                                      <div class="op_lining">
                                        <div class="box_opt_lining">
                                          ...
                                          <label id="unlined_info" style="display: none; height: auto; background: #F5F5F5; padding: 6px 24px 8px 24px; margin: 6px 0px 20px 0; position: relative; ">Unstructured blazers are perfect for warm days. A lightweight unlined, without shoulder pads to make your style more casual. It requires extra handicraft work but it is worth the result.<br/>On the other hand, suit pants keep their lining to assure their best shape.
                                            <a href="javascript:;" onclick="hide_unlined_info(this);" style="color: #999999; text-decoration: none!important; font-size: 18px; font-weight: bold; position: absolute; right: 7px; top: 0;">x</a>
                                          </label>-->
                                          <label>
                                            <input id="inp_lining_personalized_jacket" class="uniform change_lining" rel="1" type="radio" name="lining_jacket_radio" value="main_custom_color" <?php if(!empty($_SESSION['suit']['accents']['jacket_lining_type']) && $_SESSION['suit']['accents']['jacket_lining_type']=='main_custom_color' ) { ?> checked="checked" <?php } ?> price="" rel="inp_lining_personalized" box="lining"/>Custom color <!--(+14.50$)-->
                                            <?=($acc_price['jacket_lining_price']=="0.00")?'':"(+".number_format($acc_price['jacket_lining_price'])."$)";?>
                                          </label>
                                        </div>
                                          ...
                                          <div class="lining_3d">
                                            <div class="filters">
                                              <div class="preview_fabric_3d_common">
                                                <div class="preview" style="background:url(<?php echo $homeurl; ?>assets/dimg/lining/default/_big.jpg) top right no-repeat"></div>
                                              </div>
                                              <br style="clear: both;"/>
                                            </div>
                                            <!-- LOAD SLIDER FABRICS -->
                                                    ...
                                                    <!--<div class="fabric_box_3d shirt_fabric_box">
                                                      ...
                                                      <table class="info">
                                                        <tbody>
                                                          <tr>
                                                            <td class="title">
                                                              <a is_title="Albury" category="special" href="javascript:;" btn_color="" rel="123" class="select" extra="">Albury</a>
                                                            </td>
                                                            <td class="season"></td>
                                                          </tr>
                                                        </tbody>
                                    ...
                                    <div class="extra_opt extra_3d initial_opt extra_title">
                                      ...
                                      <div class="box_title box_title_new open initials main">
                                        <a href="javascript:;" class="btn_slider"></a>
                                        <p class="name">Add Embroidery
                                          <span>
                                            <?=($acc_price['embroidery_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['embroidery_price'])."$)";?>
                                          </span>
                                          <a href="javascript:;" class="btn_cancel_add" rel="initials" price="<?=$acc_price['embroidery_price'];?>">Delete</a>
                                        </p>
                                      </div>
                                            ...
                                            <div class="right">
                                              ...
                                              <div class="op_initials all_family">
                                                ...
                                                <div class="box_font_initial">
                                                  ...
                                                  <label class="positions">
                                                    <input rel="Times New Roman" class="uniform" type="radio" <?php if(!empty($_SESSION['suit']['accents']['font_family']) && $_SESSION['suit']['accents']['font_family']=='Times New Roman') { ?> checked="checked" <?php } ?> value="74" name="initials_jacket" rev="initials_type"><img src="<?php echo $homeurl; ?>assets/images/man/shirt/initials/74.png" pagespeed_url_hash="2155879771" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                          ...
                          <script type="text/javascript">
                            ...
                            var t4l_linings={"jacket":{"price":<?=$acc_price['jacket_lining_price'];?>}
                                        ...
                                        "60":{"price":14.5},
                                        "59":{"price":14.5},
                                        "57":{"price":<?=$acc_price['jacket_lining_price'];?>},
                                        "56":{"price":14.5},
                                        "55":{"price":14.5},
                                        "54":{"price":14.5},
                                        "53":{"price":14.5},
...
else if($_SESSION['p_dtl']['sub_cat_id']=='3')
{ 
