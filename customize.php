                                        ...
                                        <div class="box_opt">
                                          <div class="radio_opt">
                                            ...
                                            <label class="option">
                                              ...
                                              <input layer="extra_pants" class="uniform option_input" type="radio" name="extra_pants" value="No" <?php if($_SESSION['suit']['style']['extra_pants']=='No') { ?> checked <?php }?>>
                                              No
                                            </label>
                                          </div>
                                        </div>
                                          ...
                                          <div class="radio_opt">
                                            ...
                                            <label class="option">                                              
                                              <select layer="jacket_buttons" class="option uniform" name="jacket_buttons" id="jacket_buttons" rel="2">
                                                ...
                                                <option layer="jacket_buttons" value="2" <?php if(!empty($_SESSION['jacket']['style']['jacket_lapel_type']) && $_SESSION['jacket']['style']['jacket_buttons']=='2') { ?> selected <?php }?>>
                                                  2
                                                </option>
                                        ...
                                        <div class="box_opt">
                                          <div class="radio_opt labels_jacket_pockets_num">
                                            ...
                                            <label class="option">
                                              ...
                                              <input layer="jacket_pockets" class="uniform num_b jacket radio_opt" type="radio" name="jacket_pockets" value="2" <?php if(!empty($_SESSION['jacket']['style']['jacket_pockets']) && $_SESSION['jacket']['style']['jacket_pockets']=='2') { ?> checked <?php }?>>
                                              2 pockets
                                            </label>
                                            <label class="option">
                                          ...
                                          <div id="options_belt" class="radio_opt">
                                            <label class="option">
                                              <div class="radio" id="uniform-coat_belt_0">
                                                <span>
                                                  <input layer="coat_belt" class="uniform radio_opt coat_belt" id="coat_belt_0" type="radio" name="coat_belt" value="0" <?php if($_SESSION['coat']['style']['coat_belt']!='' && $_SESSION['coat']['style']['coat_belt']=='0') { ?> checked <?php }?>>
                                                </span>
                                              </div>
                                              No
                                            </label>
