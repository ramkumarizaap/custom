...
<body>
  ...
  <!--<div class="page_load" style="width: 400px;margin: 130px auto;">

    <img src="<?php echo $homeurl;?>assets/images/page-load.gif">
              ...
              <div class="navbar-collapse navbar-main-collapse" role="navigation">
                ...
                <ul class="nav navbar-nav">
                 ...
                 <?php
                  ...
                  <?php if($menu_dtl['cat_name'] =='Reviews' || $menu_dtl['cat_name']=='Gallery'
