                    ...
                    <div class="body_box" id="features">
                      ...
                      <div class="body_product_box_3d">
                        ...
                        <div id="man_suit">
                          ...
                          <form method="post" action="<?php echo $homeurl; ?>includes/action/action.php" id="fabric_form" class="configure_form test_C test_B">
                          ...
                          <form method="post" action="<?php echo $homeurl; ?>includes/action/action.php" id="fabric_form" class="configure_form test_C test_B">
                            ...
                            <div class="opt_box">
                              ...
                              <div class="col-md-6 pull-left">
                                ...
                                <input type="text" data-list=".default_list3" class="search_fabric form-control" placeholder="Search fabric by name, cost or description">
                          ...
                          <form method="post" action="<?php echo $homeurl; ?>includes/action/action.php" id="fabric_form" class="configure_form test_C test_B">
                            ...
                            <div class="opt_box">
                              ...
                              <div class="col-md-6 pull-left">
                                ...
                                <input type="text" data-list=".default_list4" class="search_fabric form-control" placeholder="Search fabric by name, cost or description">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h2 class="modal-title fab_name"><strong><?php echo $_SESSION['fab_dtl']['fab_name']; ?></strong></h2>
