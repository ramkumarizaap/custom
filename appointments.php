    ...
    <div class="modal-content ">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-4">
         ...
         <div class="col-md-4">
         <div class="form-group">
              <label for="email">Type of Appointment</label>
              <select class="form-control" name="appointment_type" style="margin-top: 0px;">
                <option value="">--Select--</option>
                <option value="New Fitting - 1 hour">New Fitting - 1 hour</option>
                <option value="Pick Up - 30 mins">Pick Up - 30 mins</option>
                <option value="Drop Off - 30 mins">Drop Off - 30 mins</option>
                <option value="Refitting - 30 mins">Refitting - 30 mins</option>
              </select>
        </div>
        </div>
        </div>
        <div class="row">
         ...
         <div class="col-md-3">
           <div class="form-group">
              ...
              <input type="text" class="form-control date-example past_date" id="timings" name="date">
          </div>
          </div>
             <div class="col-md-4">
           <div class="form-group">
