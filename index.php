...
<?php
	...
	if($page=="" || $page=="index" || $page=="home" || $page=="shops" || $page=="login" || 
		...
		|| $page=="checkout" || $page=="order-received" || $page=="account-information" || $page=="my-orders"
		 ...
		 || $page=="track-order"  || $page=="appointments" || $page=="tab2_fabric" || $page=="tab3_accents" || $page=="contact-us" || $page=="careers"
		 || $page=="reviews" || $page=="reviews-add" || $page=="promo" || $page=="our-story" || $page=="why-us" || $page=="gift-card" || $page=="gallery" || $page=="wedding")
	{
