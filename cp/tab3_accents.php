<?php
$result_price = mysqli_query($con,"select * from accents_master where product_type='".$_SESSION['p_dtl']['sub_cat_id']."'");
$acc_price = mysqli_fetch_array($result_price);
$pros=$site->get_custom_color_lining('',$_SESSION['p_dtl']['sub_cat_id']);
if($_SESSION['p_dtl']['sub_cat_id']=='1')
{ 
                  ...
                  <div id="body" class="man_suit2_configure garment_container">
                    ...
                    <div class="body_box" id="features">
                      ...
                      <div class="body_product_box_3d">
                        ...
                        <form method="post" id="extra_form" action="<?php echo $adminurl; ?>includes/action.php" class="configure_form man_waistcoat man_jacket man_suit">
                            ...
                            <div class="box_opts">
                              ...
                              <div id="extras_jacket">
                                  ...
                                  <div class="box_title box_title_new open lining_jacket main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['jacket_lining_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['jacket_lining_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="lining_jacket" price="<?=$acc_price['jacket_lining_price'];?>">
                                    ...
                                    <div class="op_lining">
                                      ...
                                      <div class="box_opt_lining">
                                        ...
                                        <label>
                                          ...
                                          Custom color <?=($acc_price['jacket_lining_price']=="0.00")?'':"(+".number_format($acc_price['jacket_lining_price'])."$)";?>
                                                      ...
                                                      foreach ($pros as $key => $value)
                                                      {
                                                        ...
                                                        ?>
                                                          <div class="fabric_box_3d shirt_fabric_box">
                                                            <div style="background:url('<?php echo $homeurl.$value['small_image_name']; ?>') top center no-repeat" class="image suit_lining <?php if(!empty($_SESSION['suit']['accents']['jacket_lining_id']) && $_SESSION['suit']['accents']['jacket_lining_id']=='57') { ?> selected <?php } else if($_SESSION['suit']['accents']['jacket_lining_id']=='') { ?> selected <?php } ?>" id="suit_lining_57" rel="<?=$value['large_image_name'];?>">
                                                              <img style="<?php if(!empty($_SESSION['suit']['accents']['jacket_lining_id']) && $_SESSION['suit']['accents']['jacket_lining_id']=='57') { ?> display: block; <?php } else if($_SESSION['suit']['accents']['jacket_lining_id']=='' && $i==1) { ?> display:block; <?php } else { ?> display:none; <?php } ?>" class="selected" src="<?php echo $homeurl; ?>assets/images/man/selected_fabric_3d.png" title="Selected fabric" tooltip_class="selected" pagespeed_url_hash="359993417" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                                                              <a is_title="<?=$value['name'];?>" style="position: relative; z-index: 5;" material="poliester" category="basic" href="javascript:;" rel="<?=$value['large_image_name'];?>" class="select" extra="" btn_color=""></a>
                                                            </div>
                                                            <table class="info">
                                                              <tbody>
                                                                <tr>
                                                                  <td class="title">
                                                                    <a is_title="<?=$value['name'];?>" category="basic" href="javascript:;" btn_color="" rel="<?=$value['large_image_name'];?>" class="select" extra="">
                                                                    <?=$value['name'];?></a>
                                                                  </td>
                                                                  <td class="season"><!--14,50$--></td>
                                                                </tr>
                                                              </tbody>
                                                            </table>
                                                          </div>
                                ...
                                <div class="extra_opt extra_3d initial_opt extra_title">
                                  ...
                                  <div class="box_title box_title_new open initials main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['embroidery_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['embroidery_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="initials" price="<?=$acc_price['embroidery_price'];?>">
                                  ...
                                  <div class="window initials" style="display: block;">
                                    <div id="options_lining_jacket" class="window lining top" style="display: block;">
                                          <div class="op_lining">
                                            <div class="box_opt_lining">
                                              <label layer="embroidery">
                                                <input id="embroidery_default" class="uniform default_item" type="radio" name="embroidery_type" value="embroidery_no" <?php if(!empty($_SESSION['suit']['accents']['embroidery_type']) && $_SESSION['suit']['accents']['embroidery_type']=='embroidery_no' ) { ?> checked="checked" <?php } else if($_SESSION['suit']['accents']['embroidery_type']=='') { ?> checked="checked" <?php } ?> price="0"/>
                                                No Embroidery
                                              </label>
                                              <label layer="embroidery">
                                                <input id="inp_embroidery_personalized" class="uniform personalized_item" rel="1" type="radio" name="embroidery_type" value="embroidery_yes" price="<?=$acc_price['embroidery_price'];?>" rel="inp_embroidery_personalized" <?php if(!empty($_SESSION['suit']['accents']['embroidery_type']) && $_SESSION['suit']['accents']['embroidery_type']=='embroidery_yes' ) { ?> checked="checked" <?php } ?> box="embroidery" extra_name="embroidery"/>
                                                Add Embroidery <?=($acc_price['embroidery_price']=="0.00")?'':"(+".number_format($acc_price['embroidery_price'])."$)";?>
                                              </label>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="opts_initials">
                                      ...
                                      <div class="box_opt op_initials">
                                        ...
                                        <div class="list_common_color interactive_options all_colors " rel="initials">
                                          ...
                                          <div class="option_trigger common_color <?php if(!empty($_SESSION['suit']['accents']['monogram_color']) && $_SESSION['suit']['accents']['monogram_color']==$color_name[$i]) { ?> active <?php } else if($_SESSION['suit']['accents']['monogram_color']=='' && $i==0) { ?> active <?php } ?>" href="javascript:;" rel="9" color="<?php echo $color_name[$i]; ?>">
                                  ...
                                  <div class="box_title  box_title_new open main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                       ...
                                       <?=($acc_price['button_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['button_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="metal_buttons" price="<?=$acc_price['button_price'];?>">
                                        ...
                                        <div class="box_opt_lining">
                                          ...
                                          <div style="float:left;">
                                            ...
                                            <label>
                                              ...
                                              <input layer="jacket_metal_buttons" id="inp_metal_buttons_personalized" class="uniform personalized_item" rel="1" type="radio" name="metal_buttons_radio" value="brass_button" <?php if(!empty($_SESSION['suit']['accents']['type_of_button']) && $_SESSION['suit']['accents']['type_of_button']=='brass_button' ) { ?> checked="checked" <?php } ?> price="<?=$acc_price['button_price'];?>" rel="inp_metal_buttons_personalized" box="metal_buttons" extra_name="metal_buttons"/>

                                              Brass Buttons <?=($acc_price['button_price']=="0.00")?'':"(+".number_format($acc_price['button_price'])."$)";?>
                                ...
                                <div class="extra_opt extra_3d extra_title">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['suit']['accents']['type_of_neck']) && $_SESSION['suit']['accents']['type_of_neck']!='color_by_default') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['neck_lining_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['neck_lining_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="neck_lining" price="<?=$acc_price['neck_lining_price'];?>">
                                  ...
                                  <div id="options_neck_lining" class="window top" style=<?php if(!empty($_SESSION['suit']['accents']['type_of_neck']) && $_SESSION['suit']['accents']['type_of_neck']!='color_by_default') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="op_lining">
                                      ...
                                      <div class="lateral_img2 img_neck">
                                        ...
                                        <div class="box_opt_neck_lining">
                                          ...
                                          <div>
                                            ...
                                            <label layer="jacket_neck_lining">
                                              ...
                                              <span class="price">
                                                <?=($acc_price['neck_lining_price']=="0.00")?'':"(+".number_format($acc_price['neck_lining_price'])."$)";?>
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['suit']['accents']['type_pocket_square']) && $_SESSION['suit']['accents']['type_pocket_square']!='no_pocket') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['pocket_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['pocket_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="handkerchief" price="<?=$acc_price['pocket_price'];?>">
                                          ...
                                          <div style="float:left;">
                                            ...
                                            <label>
                                              ...
                                              <span class="price">
                                                ...
                                                <?=($acc_price['pocket_price']=="0.00")?'':"(+".number_format($acc_price['pocket_price'])."$)";?>
                                ...
                                <div class="extra_opt extra_3d hilo_ojal_opt extra_title">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['suit']['accents']['colored_thread_type']) || !empty($_SESSION['suit']['accents']['colored_holes_type']) || !empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) || $_SESSION['suit']['accents']['type_of_colored_button_holes']=='by_default') { ?> open <?php } else { ?> close <?php } ?> hilo_ojal main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                       ...
                                       <?=($acc_price['threads_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['threads_price'])."$)";?>

                                      </span>

                                      <a id="cancel_button_holes_threads" href="javascript:;" class="btn_cancel_add" rel="button_holes_threads" price="<?=$acc_price['threads_price'];?>">
                                  ...
                                  <div class="window hilo_ojal" style=<?php if(!empty($_SESSION['suit']['accents']['colored_thread_type']) || !empty($_SESSION['suit']['accents']['colored_holes_type']) || !empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) || $_SESSION['suit']['accents']['type_of_colored_button_holes']=='by_default') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="apply_at">
                                      ...
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="lapel" id="pos_bht_solapa" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='lapel' ) { ?> checked="checked" <?php } ?> value="lapel"/>
                                        Lapel Button Hole
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_button" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='first_button' ) { ?> checked="checked" <?php } ?> value="first_button"/>
                                        First Jacket button hole
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_sleeve" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='first_sleeve' ) { ?> checked="checked" <?php } ?> value="first_sleeve"/>
                                        First Sleeve Button Hole (Both Arms)
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_sleeve_jacket" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='first_sleeve_jacket' ) { ?> checked="checked" <?php } ?> value="first_sleeve_jacket"/>
                                        First Jacket & First Sleeves Button Hole
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="lapel_jacket_button" id="pos_bht_all" class="uniform thread_holes_selector suit_hole_not_default" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='lapel_jacket_button' ) { ?> checked="checked" <?php }  ?> value="lapel_jacket_button"/>
                                        Lapel and First Jacket Button Hole
                                      </label>
                                      
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="lapel_jakcet_sleeves" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['suit']['accents']['type_of_colored_button_holes']) && $_SESSION['suit']['accents']['type_of_colored_button_holes']=='lapel_jakcet_sleeves' ) { ?> checked="checked" <?php } ?> value="lapel_jakcet_sleeves"/>
                                        Lapel & First Jacket & First Sleeves Button Hole
                                      </label>
                                    ...
                                    <div id="button_thread_type" style="display:none;">
                                      <div class="shirtsection" id="placket_only">
                                        <div class="button-threads">
                                          <img class="color" src="<?php echo $homeurl; ?>assets/images/man/suit/placket_only.png" pagespeed_url_hash="3252763963" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                                        </div>
                                          ...
                                          if(count($color_img) > 0)
                                           {
                                              ...
                                              {
                                                ?>
                                                <div layer="jacket_button_thread" class="option_trigger common_color <?php if(!empty($_SESSION['suit']['accents']['lapel_color']) && $_SESSION['suit']['accents']['lapel_color']==$color_name[$j] ) { ?> active1 <?php } ?>" href="javascript:;" rel="9" color="<?php echo $color_name[$j]; ?>">
                                            ...
                                            { 
                                              ...
                                              foreach($color_img as $key=>$value)
                                              {
                                                ...
                                                <div class="option_trigger common_color  <?php if(!empty($_SESSION['suit']['accents']['colored_holes_type']) && $_SESSION['suit']['accents']['colored_holes_type']== $color_name[$l] ) { ?> active <?php } ?>" href="javascript:;" rel="9" color="<?php echo $color_name[$l]; ?>">
                                                  <a layer="jacket_button_holes1" class="box_color" href="javascript:;"><div class="active"></div>
                                                    <img class="color" src="<?php echo $homeurl.$value; ?>" pagespeed_url_hash="3252763963" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                                                  </a>
                                                </div>
                                                <?php ++$l; 
                                    ...
                                    <div id="lapel_jacket_button">
                                      <div class="shirtsection">
                                        <div class="button-holes">
                                          <img class="color" src="<?php echo $homeurl; ?>assets/images/man/suit/lapel_jacket_button.png" pagespeed_url_hash="3252763963" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                                        </div>
                                        <?php 
                                          $get_btn_holes_dtl = $site->get_accent_color($_SESSION['p_dtl']['sub_cat_id'],'5');
                                          $color_img = explode(",", $get_btn_holes_dtl[0]['color_img']);
                                    ...
                                    <div id="jacket_only" style="display: none;margin-top: 70px;">
                                      <div class="shirtsection">
                                      <div class="button-threads">
                                        <img class="color" src="<?php echo $homeurl; ?>assets/images/man/suit/first_jacket.png" pagespeed_url_hash="3252763963" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                                      </div>
                                      <div id="box_button_threads_extra" class="list_common_color interactive_options all_colors placket_only" rel="button_holes_threads">
                                          <input id="hidden_button_threads1" class="option_input1" type="hidden" name="placket_color" value="<?php if(!empty($_SESSION['suit']['accents']['lapel_color'])) { echo $_SESSION['suit']['accents']['lapel_color']; } ?>"/>
                                            <?php
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['suit']['accents']['type_of_elbow']) && $_SESSION['suit']['accents']['type_of_elbow']!='elbow_no') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                         ...
                                         <?=($acc_price['elbow_patch_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['elbow_patch_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="patches" price="<?=$acc_price['elbow_patch_price'];?>">
                                        ...
                                        <div class="box_opt_patches">
                                          ...
                                          <div>
                                            ...
                                            <label layer="jacket_patches">
                                              ...
                                              <input id="patches_default" class="uniform default_item" type="radio" name="patches_radio" value="elbow_no" <?php if(!empty($_SESSION['suit']['accents']['type_of_elbow']) && $_SESSION['suit']['accents']['type_of_elbow']=='elbow_no' ) { ?> checked="checked" <?php } else if($_SESSION['suit']['accents']['type_of_elbow']=='') { ?> checked="checked" <?php } ?> price="13.95"/>
                                            ...
                                            <label layer="jacket_patches">
                                              ...
                                              <span class="price">
                                                ...
                                                <?=($acc_price['elbow_patch_price']=="0.00")?'':"(+".number_format($acc_price['elbow_patch_price'])."$)";?>
                          ...
                          <script type="text/javascript">
                            ...
                            var t4l_linings={"jacket":{"price":<?=$acc_price['jacket_lining_price'];?>}
                           ...
                           <script type="text/javascript">
                            ...
                            var suit_price = {
                              ...
                              "embroidery" : <?php if(!empty($_SESSION['suit']['accents']['embroidery_price'])) { echo $_SESSION['suit']['accents']['embroidery_price']; } else { echo 0; } ?>
                            ...
                            var extra_prices = {
                              ...
                              "embroidery_design":<?=$acc_price['embroidery_price'];?>,

                             "elbow_patches" : <?=$acc_price['elbow_patch_price'];?>,

                              "btn_holes_threads" : <?=$acc_price['threads_price'];?>,

                              "metal_btn" :<?=$acc_price['button_price'];?> ,

                              "neck_lining":<?=$acc_price['neck_lining_price'];?>,

                              "pocket_square" :<?=$acc_price['pocket_price'];?> 
                        ...
                        <input type="hidden" name="fabric_name1" value="<?php echo $_SESSION['jacket']['fabric']['fabric_name']; ?>">  
                          ...
                          <div style="margin:0 auto;font-weight:bold;text-align:center;width:320px;padding: 0px 110px 20px 0px;">
                            ...
                            <div id="move">
                              ...
                              <div id="model_3d_preview" class="man_suit col-md-11" style="position: relative;left:13px;">
                              ...
                              <div id="extras_jacket">
                                    ...
                                    <div class="op_lining">
                                      ...
                                      <div class="box_opt_lining">
                                        ...
                                        <label>
                                          ...
                                          <input id="inp_lining_personalized_jacket" class="uniform change_lining" rel="1" type="radio" name="lining_jacket_radio" value="main_custom_color" <?php if(!empty($_SESSION['jacket']['accents']['jacket_lining_type']) && $_SESSION['jacket']['accents']['jacket_lining_type']=='main_custom_color' ) { ?> checked="checked" <?php } ?> price="" rel="inp_lining_personalized" box="lining"/>
                                                      ...
                                                      if($pros)
                                                      {
                                                        ...
                                                        foreach ($pros as $key => $value)
                                                        {
                                                          ...
                                                          ?>
                                                            ...
                                                            <div class="fabric_box_3d shirt_fabric_box">
                                                              <div style="background:url(<?php echo $homeurl.$value['small_image_name']; ?>) top center no-repeat" class="image suit_lining <?php if(!empty($_SESSION['jacket']['accents']['jacket_lining_id']) && $_SESSION['jacket']['accents']['jacket_lining_id']=='57') { ?> selected <?php } else if($_SESSION['jacket']['accents']['jacket_lining_id']=='') { ?> selected <?php } ?>" id="suit_lining_57" rel="<?=$value['large_image_name'];?>">
                                                                <img style="<?php if(!empty($_SESSION['jacket']['accents']['jacket_lining_id']) && $_SESSION['jacket']['accents']['jacket_lining_id']=='57') { ?> display: block; <?php } else if($_SESSION['jacket']['accents']['jacket_lining_id']=='' && $i==1) { ?> display:block; <?php } else { ?> display:none; <?php } ?>"  class="selected" src="<?php echo $homeurl; ?>assets/images/man/selected_fabric_3d.png" title="Selected fabric" tooltip_class="selected" pagespeed_url_hash="359993417" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                                                                <a is_title="<?=$value['name'];?>" style="position: relative; z-index: 5;" material="poliester" category="basic" href="javascript:;" rel="<?=$value['large_image_name'];?>" class="select" extra="" btn_color="">
                                                                </a>
                                                              </div>
                                                              <table class="info">
                                                                <tbody>
                                  ...
                                  <div class="window initials" style="display: block;">
                                    <div id="options_lining_jacket" class="window lining top" style="display: block;">
                                          <div class="op_lining">
                                            <div class="box_opt_lining">
                                              <label layer="embroidery">
                                                <input id="embroidery_default" class="uniform default_item" type="radio" name="embroidery_type" value="embroidery_no" <?php if(!empty($_SESSION['jacket']['accents']['embroidery_type']) && $_SESSION['jacket']['accents']['embroidery_type']=='embroidery_no' ) { ?> checked="checked" <?php } else if($_SESSION['jacket']['accents']['embroidery_type']=='') { ?> checked="checked" <?php } ?> price="0"/>
                                                No Embroidery
                                              </label>
                                              <label layer="embroidery">
                                                <input id="inp_embroidery_personalized" class="uniform personalized_item" rel="1" type="radio" name="embroidery_type" value="embroidery_yes" price="<?=$acc_price['embroidery_price'];?>" rel="inp_embroidery_personalized" <?php if(!empty($_SESSION['jacket']['accents']['embroidery_type']) && $_SESSION['jacket']['accents']['embroidery_type']=='embroidery_yes' ) { ?> checked="checked" <?php } ?> box="embroidery" extra_name="embroidery"/>
                                                Add Embroidery <?=($acc_price['embroidery_price']=="0.00")?'':"(+".number_format($acc_price['embroidery_price'])."$)";?>
                                              </label>
                                            </div>
                                          </div>
                                    ...
                                    <div class="opts_initials">
                                      ...
                                      <div class="box_opt op_initials">
                                        ...
                                        <div class="list_common_color interactive_options all_colors " rel="initials">
                                          ...
                                          <input class="" type="hidden" name="initials_jacket1" value="<?php if(!empty($_SESSION['jacket']['accents']['monogram_color'])) { echo $_SESSION['jacket']['accents']['monogram_color']; } else if($_SESSION['jacket']['accents']['monogram_color']=='') { echo $color_name[0]; } ?>"/>
                                          ...
                                          <div class="option_trigger common_color <?php if(!empty($_SESSION['jacket']['accents']['monogram_color']) && $_SESSION['jacket']['accents']['monogram_color']==$color_name[$i]) { ?> active <?php } else if($_SESSION['jacket']['accents']['monogram_color']=='' && $i==0) { ?> active <?php } ?>" href="javascript:;" rel="9" color="<?php echo $color_name[$i]; ?>">
                                ...
                                <div class="extra_opt extra_3d extra_title">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['jacket']['accents']['type_of_neck']) && $_SESSION['jacket']['accents']['type_of_neck']!='color_by_default') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <a href="javascript:;" class="btn_cancel_add" rel="neck_lining" price="<?=$acc_price['neck_lining_price'];?>s">
                                ...
                                <!-- HILOS/OJALES DE LOS BOTONES (man_jacket_button_holes_threads) -->
                                 ...
                                 <div class="extra_opt extra_3d hilo_ojal_opt extra_title">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['jacket']['accents']['colored_thread_type']) || !empty($_SESSION['jacket']['accents']['colored_holes_type']) || !empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) || $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='by_default') { ?> open <?php } else { ?> close <?php } ?> hilo_ojal main">
                                  ...
                                  <div class="window hilo_ojal" style=<?php if(!empty($_SESSION['jacket']['accents']['colored_thread_type']) || !empty($_SESSION['jacket']['accents']['colored_holes_type']) || !empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) || $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='by_default') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="apply_at">
                                      ...
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_button" id="pos_bht_all" class="uniform thread_holes_selector suit_hole_not_default" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) && $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='first_button' ) { ?> checked="checked" <?php }  ?> value="first_button"/>
                                        First Jacket button hole
                                      </label>                                      
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_sleeve" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) && $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='first_sleeve' ) { ?> checked="checked" <?php } ?> value="first_sleeve"/>
                                        First Sleeve Button Hole (Both Arms)
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="first_sleeve_jacket" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) && $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='first_sleeve_jacket' ) { ?> checked="checked" <?php } ?> value="first_sleeve_jacket"/>
                                        First Jacket & First Sleeves Button Hole
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="lapel_jacket_button" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) && $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='lapel_jacket_button' ) { ?> checked="checked" <?php } ?> value="lapel_jacket_button"/>
                                        Lapel and First Jacket Button Hole
                                      </label>
                                      <label layer="jacket_button_holes">
                                        <input layer="jacket_button_holes" layer1="lapel_jakcet_sleeves" id="pos_bht_cuff" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['jacket']['accents']['type_of_colored_button_holes']) && $_SESSION['jacket']['accents']['type_of_colored_button_holes']=='lapel_jakcet_sleeves' ) { ?> checked="checked" <?php } ?> value="lapel_jakcet_sleeves"/>
                                        Lapel & First Jacket & First Sleeves Button Hole
                                      </label>
                                    ...
                                    <div id="jacket_only" style="display: none;margin-top: 10px;">
                                      <div class="shirtsection">
                                      <div class="button-threads">
                                        <img class="color" src="<?php echo $homeurl; ?>assets/images/man/suit/first_jacket.png" pagespeed_url_hash="3252763963" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
                                      </div>
                                    ...
                                    <div class="op_patches">
                                      ...
                                      <div class="lateral_right">
                                        <div class="box_opt_patches">
                                          <div>
                                            <label layer="jacket_patches">
                                              <input id="patches_default" class="uniform default_item" type="radio" name="patches_radio" value="elbow_no" <?php if(!empty($_SESSION['jacket']['accents']['type_of_elbow']) && $_SESSION['jacket']['accents']['type_of_elbow']=='elbow_no' ) { ?> checked="checked" <?php } else if($_SESSION['jacket']['accents']['type_of_elbow']=='') { ?> checked="checked" <?php } ?> price="<?=$acc_price['elbow_patch_price'];?>"/>
                                              No elbow patches
                                            </label>
                                            <label layer="jacket_patches">
                                              <input id="inp_patches_personalized" class="uniform personalized_item" rel="1" type="radio" name="patches_radio" value="elbow_yes" price="<?=$acc_price['elbow_patch_price'];?>" rel="inp_patches_personalized" <?php if(!empty($_SESSION['jacket']['accents']['type_of_elbow']) && $_SESSION['jacket']['accents']['type_of_elbow']=='elbow_yes' ) { ?> checked="checked" <?php } ?> box="patches" extra_name="patches"/>
                                              Add elbow patches
                                              <span class="price">
                                                <?=($acc_price['elbow_patch_price']=="0.00")?'':"(+".number_format($acc_price['elbow_patch_price'])."$)";?>
                                              </span>
                          ...
                          <script type="text/javascript">
                           ...
                           <script type="text/javascript">
                            ...
                            var suit_price = {
                              ...
                              "embroidery" : <?php if(!empty($_SESSION['jacket']['accents']['embroidery_price'])) { echo $_SESSION['jacket']['accents']['embroidery_price']; } else { echo 0; } ?>
...
if(!empty($_SESSION['shirt']['fabric']['fabric_id'])) {
                            ...
                            <div class="box_opts">
                              ...
                              <div id="extras_jacket">
                                ...
                                <div class="extra_opt extra_3d initial_opt extra_title">
                                  ...
                                  <div class="box_title box_title_new open initials main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['monogram_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['monogram_price'])."$)";?>
                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="initials" price="<?=$acc_price['monogram_price'];?>">
                                  ...
                                  <div class="window initials" style="display: block;">
                                    <div id="options_lining_jacket" class="window lining top" style="display: block;">
                                      <div class="op_lining">
                                        <div class="box_opt_lining">
                                          <label layer="monogram">
                                            <input id="monogram_default" class="uniform default_item" type="radio" name="monogram_type" value="monogram_no" <?php if(!empty($_SESSION['shirt']['accents']['monogram_type']) && $_SESSION['shirt']['accents']['monogram_type']=='monogram_no' ) { ?> checked="checked" <?php } else if($_SESSION['shirt']['accents']['monogram_type']=='') { ?> checked="checked" <?php } ?> price="0" extra_name="monogram"/>
                                            No Monogram
                                          </label>
                                          <label layer="monogram">
                                            <input id="inp_monogram_personalized" class="uniform personalized_item" rel="1" type="radio" name="monogram_type" value="monogram_yes" price="<?=$acc_price['monogram_price'];?>" rel="inp_monogram_personalized" <?php if(!empty($_SESSION['shirt']['accents']['monogram_type']) && $_SESSION['shirt']['accents']['monogram_type']=='monogram_yes' ) { ?> checked="checked" <?php } ?> box="monogram" extra_name="monogram"/>
                                            Add Monogram <?=($acc_price['monogram_price']=="0.00")?'':"(+".number_format($acc_price['monogram_price'])."$)";?>
                                          </label>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="opts_initials">
                                      ...
                                      <div class="box_opt op_initials">
                                        ...
                                        <div class="list_common_color interactive_options all_colors " rel="initials">
                                          ...
                                          <input class="option_input" type="hidden" name="initials_jacket1" value="<?php if(!empty($_SESSION['shirt']['accents']['monogram_color'])) { echo $_SESSION['shirt']['accents']['monogram_color']; } else if($_SESSION['shirt']['accents']['monogram_color']=='') { echo $color_name[0]; } ?>"/>
                                          ...
                                          <div class="option_trigger common_color <?php if(!empty($_SESSION['shirt']['accents']['monogram_color']) && $_SESSION['shirt']['accents']['monogram_color']==$color_name[$i]) { ?> active <?php } else if($_SESSION['shirt']['accents']['monogram_color']=='' && $i==0) { ?> active <?php } ?>" href="javascript:;" rel="<?php echo $color_name[$i]; ?>" color="<?php echo $color_name[$i]; ?>">
                                ...
                                <div class="extra_opt extra_3d extra_title collar-lining">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['shirt']['accents']['neck_styling']) && trim($_SESSION['shirt']['accents']['neck_styling'])!='') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['collar_lining_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['collar_lining_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="neck_styling" price="<?=$acc_price['collar_lining_price'];?>">
                                  ...
                                  <div id="options_neck_lining" class="window top neck_styling" style=<?php if(!empty($_SESSION['shirt']['accents']['neck_styling']) && trim($_SESSION['shirt']['accents']['neck_styling'])!='') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="op_lining">
                                      ...
                                      <div class="lateral_right">
                                       ...
                                       <input type="hidden" name="neck_lining_price" value="<?php if(!empty($_SESSION['shirt']['accents']['neck_lining_price'])) { echo $_SESSION['shirt']['accents']['neck_lining_price']; } ?>">
                                        ...
                                        <div layer="collar_neck_lining" class="option_trigger common_th mini_pocket collar_inner_fabric <?php if(!empty($_SESSION['shirt']['accents']['neck_styling']) && $_SESSION['shirt']['accents']['neck_styling']=='inner_fabric') { ?> active <?php }  ?>" href="javascript:;" rel="neck_lining" price="<?=$acc_price['collar_lining_price'];?>">
                                          ...
                                          <div layer="collar_neck_lining" class="option_trigger common_th mini_pocket collar_outer_fabric <?php if(!empty($_SESSION['shirt']['accents']['neck_styling']) && $_SESSION['shirt']['accents']['neck_styling']=='outer_fabric') { ?> active <?php }  ?>" href="javascript:;" rel="neck_lining" price="<?=$acc_price['collar_lining_price'];?>">
                                    ...
                                    <div class="list_common_color interactive_options all_colors collar_neck_col" rel="neck_lining" price="<?=$acc_price['collar_lining_price'];?>">
                                ...
                                <div class="extra_opt extra_3d extra_title collar-lining">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['shirt']['accents']['cuff_styling']) && trim($_SESSION['shirt']['accents']['cuff_styling'])!='') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">
                                      ...
                                      <span>
                                        ...
                                        <?=($acc_price['cuff_style_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['cuff_style_price'])."$)";?>

                                      </span>

                                      <a href="javascript:;" class="btn_cancel_add" rel="cuff_styling" price="<?=$acc_price['cuff_style_price'];?>">
                                  ...
                                  <div id="options_handkerchief" class="window handkerchief top cuff_styling" style=<?php if(!empty($_SESSION['shirt']['accents']['cuff_styling']) && trim($_SESSION['shirt']['accents']['cuff_styling'])!='') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="op_handkerchief">
                                      ...
                                      <div class="lateral_right" style="float:none;">
                                       ...
                                       <input type="hidden" name="handkerchief_price" value="<?php if(!empty($_SESSION['shirt']['accents']['cuff_lining_price'])) { echo $_SESSION['shirt']['accents']['cuff_lining_price']; } ?>">
                                        ...
                                        <div layer="collar_neck_lining" class="option_trigger common_th mini_pocket cuff_inner_fabric <?php if(!empty($_SESSION['shirt']['accents']['cuff_styling']) && $_SESSION['shirt']['accents']['cuff_styling']=='inner_fabric') { ?> active <?php }  ?>" href="javascript:;" rel="handkerchief" price="<?=$acc_price['cuff_style_price'];?>">
                                          ...
                                          <div layer="collar_neck_lining" class="option_trigger common_th mini_pocket cuff_outer_fabric <?php if(!empty($_SESSION['shirt']['accents']['cuff_styling']) && $_SESSION['shirt']['accents']['cuff_styling']=='outer_fabric') { ?> active <?php }  ?>" href="javascript:;" rel="handkerchief" price="<?=$acc_price['cuff_style_price'];?>">
                                    ...
                                    <div class="list_common_color interactive_options all_colors cuff_col" rel="handkerchief" price="<?=$acc_price['cuff_style_price'];?>">
                                ...
                                <div class="extra_opt extra_3d hilo_ojal_opt extra_title">
                                  ...
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['shirt']['accents']['colored_thread_type']) || !empty($_SESSION['shirt']['accents']['colored_holes_type'])) { ?> open <?php } else { ?> close <?php } ?> hilo_ojal main">
                                  ...
                                  <div class="window hilo_ojal" style=<?php if(!empty($_SESSION['shirt']['accents']['colored_thread_type']) || !empty($_SESSION['shirt']['accents']['colored_holes_type'])) { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="apply_at">
                                      ...
                                      <label layer="jacket_button_holes">
                                        ...
                                        <input layer="jacket_button_holes" id="pos_bht_all" class="uniform thread_holes_selector suit_hole_not_default" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['shirt']['accents']['type_of_colored_button_holes']) && $_SESSION['shirt']['accents']['type_of_colored_button_holes']=='only_cuff_button' ) { ?> checked="checked" <?php } ?> value="only_cuff_button"/>

                                        <!-- Lapel and First Sleeve Button Hole -->
                                        Only Cuff Button
                                      ...
                                      <label layer="jacket_button_holes">
                                        ...
                                        <input layer="jacket_button_holes" id="pos_bht_solapa" class="uniform thread_holes_selector suit_hole_not_default" rel="1" type="radio" name="button_holes_threads_jacket" <?php if(!empty($_SESSION['shirt']['accents']['type_of_colored_button_holes']) && $_SESSION['shirt']['accents']['type_of_colored_button_holes']=='all - cuff & placket' ) { ?> checked="checked" <?php } ?> value="all - cuff & placket"/>
                                   ...
                                   <!-- <div id="img_ojal_hilo">
                                    ...
                                    <div class="list_common_color interactive_options all_colors" rel="button_holes_threads">
                                      ...
                                      <div class="option_trigger common_color  <?php if(!empty($_SESSION['shirt']['accents']['colored_holes_type']) && $_SESSION['shirt']['accents']['colored_holes_type']==$color_name[$m] ) { ?> active <?php } ?>" href="javascript:;" rel="9" color="<?php echo $color_name[$m]; ?>" type="ojal">
                          ...
                          var config = {
                           ...
                           <script type="text/javascript">
                            ...
                            var shirt_price = {
                              ...
                              "initials_jacket":<?php if(!empty($_SESSION['shirt']['accents']['initials_jacket'])) { echo $_SESSION['shirt']['accents']['initials_jacket']; } else { echo 0; } ?>
                            ...
                            var extra_prices = {
                             ...
                             "elbow_patches" : <?=$acc_price['elbow_patch_price'];?>,
                              ...
                              "metal_btn" :<?=$acc_price['button_price'];?> ,
                               ...
                               "neck_lining":<?=$acc_price['collar_lining_price'];?>,

                              "pocket_square" :<?=$acc_price['cuff_style_price'];?> 
  ...
  <?php } 
    if($_SESSION['p_dtl']['sub_cat_id']=='5') { 
// echo "<pre>";
// print_r($_SESSION['coat']);
// exit;
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-7">
                      ...
                      <div class="c-nav cf" id="extra_forms">
                        ...
                        <a href="javascript:;" class="next step_next btn btn-danger pull-right">
                        ...
                        <span id="price_img" class="garment_price btn btn-primary pull-right">
                  ...
                  <div id="body" class="Man_Coat2_configure garment_container">
                    ...
                    <div class="body_box" id="features">
                      ...
                      <div class="body_product_box_3d">
                        ...
                        <form method="post" id="extra_form" action="<?php echo $adminurl; ?>includes/action.php" class="configure_form man_waistcoat man_jacket Man_Coat">
                          <input type="hidden" name="def_fab_id" value="<?php echo $_SESSION['fab_dtl3']['fab_default_id']; ?>">
                          <input type="hidden" name="p_img_dtl" value="<?php echo $homeurl.$_SESSION['fab_dtl']['fab_default_img']; ?>">
                          <input type="hidden" name="section" value="accents">
                          <input type="hidden" name="order_id" value="<?php echo $_SESSION['oid']; ?>">
                            ...
                            <div class="box_opts">
                              ...
                              <div id="extras_jacket">
                                    ...
                                    <div class="op_lining">
                                      ...
                                      <div class="box_opt_lining">
                                        ...
                                        <label>
                                          ...
                                          Custom color <?=($acc_price['jacket_lining_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['jacket_lining_price'])."$)";?>
                                      ...
                                      <div id="lining_box_jacket" class="personalized_box" extra_name="lining_jacket" style="<?php if(!empty($_SESSION['coat']['accents']['jacket_lining_type']) && $_SESSION['coat']['accents']['jacket_lining_type']=="main_custom_color") { echo "display:block"; } else {echo "display:none"; } ?>">
                                        ...
                                        <div class="lining_3d">
                                          ...
                                          <input type="hidden" name="lining_jacket_price" value="<?php if(!empty($_SESSION['coat']['accents']['lining_price'])) { echo $_SESSION['coat']['accents']['lining_price']; } ?>">
                                                ...
                                                <tbody>
                                                  ...
                                                  if($pros)
                                                  {
                                                    ...
                                                    foreach ($pros as $key => $value)
                                                    {
                                                      ...
                                                      ?>
                                                      <div class="fabric_box_3d shirt_fabric_box">
                                                        <div style="background:url(<?php echo $homeurl.$value['small_image_name']; ?>) top center no-repeat" class="image suit_lining <?php if(!empty($_SESSION['coat']['accents']['jacket_lining_id']) && $_SESSION['coat']['accents']['jacket_lining_id']=='57') { ?> selected <?php } else if($_SESSION['coat']['accents']['jacket_lining_id']=='') { ?> selected <?php } ?>" id="suit_lining_57" rel="<?=$value['large_image_name'];?>">
                                                          <img style="<?php if(!empty($_SESSION['coat']['accents']['jacket_lining_id']) && $_SESSION['coat']['accents']['jacket_lining_id']=='57') { ?> display: block; <?php } else if($_SESSION['coat']['accents']['jacket_lining_id']=='' && $i==1) { ?> display:block; <?php } else { ?> display:none; <?php } ?>" class="selected" src="<?php echo $homeurl; ?>assets/images/man/selected_fabric_3d.png" title="Selected fabric" tooltip_class="selected" >
                                                          <a is_title="<?=$value['name'];?>" style="position: relative; z-index: 5;" material="poliester" category="basic" href="javascript:;" rel="<?=$value['large_image_name'];?>" class="select" extra="" btn_color="">
                                                          </a>
                                                        </div>
                                                        <table class="info">
                                ...
                                <div class="extra_opt extra_3d initial_opt extra_title">
                                  ...
                                  <input type="hidden" name="embroidery_price" value="<?php if(!empty($_SESSION['coat']['accents']['embroidery_price'])) { echo $_SESSION['coat']['accents']['embroidery_price']; } ?>">
                                  <div class="window initials" style="display: block;">
                                    <div id="options_lining_jacket" class="window lining top" style="display: block;">
                                      <div class="op_lining">
                                        <div class="box_opt_lining">
                                          <label layer="embroidery">
                                            <input id="embroidery_default" class="uniform default_item" type="radio" name="embroidery_type" value="embroidery_no" <?php if(!empty($_SESSION['coat']['accents']['embroidery_type']) && $_SESSION['coat']['accents']['embroidery_type']=='embroidery_no' ) { ?> checked="checked" <?php } else if($_SESSION['coat']['accents']['embroidery_type']=='') { ?> checked="checked" <?php } ?> price="0"/>
                                            No Embroidery
                                          </label>
                                          <label layer="embroidery">
                                            <input id="inp_embroidery_personalized" class="uniform personalized_item" rel="1" type="radio" name="embroidery_type" value="embroidery_yes" price="<?=$acc_price['embroidery_price'];?>" rel="inp_embroidery_personalized" <?php if(!empty($_SESSION['coat']['accents']['embroidery_type']) && $_SESSION['coat']['accents']['embroidery_type']=='embroidery_yes' ) { ?> checked="checked" <?php } ?> box="embroidery" extra_name="embroidery"/>
                                            Add Embroidery <?=($acc_price['embroidery_price']=="0.00")?'':"(+".number_format($acc_price['embroidery_price'])."$)";?>
                                          </label>
                                        </div>
                                      </div>
                                  ...
                                  <div class="window hilo_ojal" style=<?php if(!empty($_SESSION['coat']['accents']['colored_thread_type']) || !empty($_SESSION['coat']['accents']['colored_holes_type']) || !empty($_SESSION['coat']['accents']['lapel_color']) || !empty($_SESSION['coat']['accents']['type_of_colored_button_holes']) || $_SESSION['coat']['accents']['type_of_colored_button_holes']=='by_default') { ?> "display: block" <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="apply_at">
                                      ...
                                      <!-- <label layer="jacket_button_holes" class="not_default">
                                        ...
                                        First Button Hole on Coat and Sleeves
                                    ...
                                    <img class="color" src="<?php echo $homeurl; ?>assets/images/man/suit/coat_only.png" />
                                ...
                                <div class="extra_opt extra_3d extra_title">
                                  <div class="box_title box_title_new <?php if(!empty($_SESSION['coat']['accents']['type_of_elbow']) && $_SESSION['coat']['accents']['type_of_elbow']!='elbow_no') { ?> open <?php } else { ?> close <?php } ?> main">
                                    ...
                                    <p class="name">Add elbow patches 
                                      <span><?=($acc_price['elbow_patch_price']=="0.00")?'(Complimentary Add-on)':"(+".number_format($acc_price['elbow_patch_price'])."$)";?></span>
                                      <a href="javascript:;" class="btn_cancel_add" rel="patches" price="<?=$acc_price['elbow_patch_price'];?>">Delete</a>
                                    </p>
                                  </div>
                                  ...
                                  <div id="options_patches" class="window top" style=<?php if(!empty($_SESSION['coat']['accents']['type_of_elbow']) && $_SESSION['coat']['accents']['type_of_elbow']!='elbow_no') { ?> "display:block"  <?php } else { ?> "display:none;" <?php } ?>>
                                    ...
                                    <div class="op_patches">
                                      <div class="lateral_img img_patches2"></div>
                                      <div class="lateral_right">
                                        <div class="box_opt_patches">
                                          <div>
                                            <label layer="jacket_patches">
                        ...
                        <script type="text/javascript">
                            ...
                            var id_t4l_lining={"jacket":"57","waistcoat":"57"};
                            var t4l_linings={"jacket":{"price":"<?=$acc_price['jacket_lining_price'];?>"}};
                                     /*,"123":{"price":0},"117":{"price":0},"116":{"price":0},"112":{"price":14.5}
                                      ,"111":{"price":19.5},"110":{"price":19.5},"109":{"price":19.5},"104":{"price":19.5}
                                      ,"103":{"price":19.5},"102":{"price":19.5},"101":{"price":19.5},"100":{"price":19.5}
                                      ,"98":{"price":19.5},"96":{"price":19.5},"92":{"price":14.5},"91":{"price":14.5}
                                      ,"90":{"price":14.5},"89":{"price":14.5},"88":{"price":14.5},"87":{"price":14.5}
                                      ,"86":{"price":14.5},"85":{"price":14.5},"84":{"price":14.5},"81":{"price":19.5}
                                      ,"79":{"price":19.5},"69":{"price":14.5},"65":{"price":14.5},"64":{"price":14.5}
                                      ,"63":{"price":14.5},"61":{"price":14.5},"60":{"price":14.5},"59":{"price":14.5}
                                      ,"57":{"price":10},"56":{"price":14.5},"55":{"price":14.5},"54":{"price":14.5}
                                      ,"53":{"price":14.5},"52":{"price":14.5},"51":{"price":14.5},"50":{"price":14.5}
                                      ,"35":{"price":14.5},"33":{"price":14.5},"30":{"price":14.5},"29":{"price":14.5}
                                      ,"26":{"price":14.5},"21":{"price":14.5},"19":{"price":14.5},"18":{"price":14.5}*/
                      ...
                      <script type="text/javascript">
                        var coat_price = {
                              ...
                              "button_holes_threads_jacket" : <?php if(!empty($_SESSION['coat']['accents']['button_holes_price'])) { echo $_SESSION['coat']['accents']['button_holes_price']; } else { echo 0; } ?>,
                               "lining_jacket" : <?php if(!empty($_SESSION['coat']['accents']['lining_price'])) { echo $_SESSION['coat']['accents']['lining_price']; } else { echo 0; } ?>,
                               "initials" : <?php if(!empty($_SESSION['coat']['accents']['embroidery_price'])) { echo $_SESSION['coat']['accents']['embroidery_price']; } else { echo 0; } ?>,
                               "neck_lining" : <?php if(!empty($_SESSION['coat']['accents']['neck_lining'])) { echo $_SESSION['coat']['accents']['neck_lining']; } else { echo 0; } ?> 
                            }; 
                            var extra_prices = {
                              "embroidery_design":<?=$acc_price['embroidery_price'];?>,
                              "elbow_patches" : <?=$acc_price['elbow_patch_price'];?>,
