...
case "wedding-add":
	...
	break;
	case "accents":
		require_once("property/accents.php");
	break;
		case "jacket_lining":
		require_once("property/custom_color.php");
	break;
	case "jacket_lining_add":
		require_once("property/custom-color-add.php");
	break;
	case "showroom_template":
		require_once("showroom_template.php");
	break;
}
