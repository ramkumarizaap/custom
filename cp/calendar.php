      ...
      $(function () {
        ...
        $('.calendar2').fullCalendar({
          ...
          while($r=mysqli_fetch_array($sql))
            {
              $timings = date("m/d/Y h:i a",strtotime($r['a_date']." ".$r['a_time']));
              ?>
            {
              title: '<?php echo $r['a_name'];?>\r\n<?php echo $r['a_type'];?>',
              start: '<?php echo $r['a_date'];?>',
              backgroundColor: "#f56954", //red
              borderColor: "#f56954", //red,
              a_name:"<?php echo mysqli_real_escape_string($con,trim($r['a_name']));?>",
              a_id:"<?php echo mysqli_real_escape_string($con,trim($r['a_id']));?>",
              a_email:"<?php echo mysqli_real_escape_string($con,trim($r['a_email']));?>",
              a_type:"<?php echo mysqli_real_escape_string($con,trim($r['a_type']));?>",
              a_phone:"<?php echo mysqli_real_escape_string($con,trim($r['a_phone']));?>",
              a_timing:"<?php echo mysqli_real_escape_string($con,trim($timings));?>",
          ...
          eventClick:function(event)
          {
            //console.log(event);
              ...
              $(".a_name").html(event.a_name);
              $(".a_email").html(event.a_email);
              $(".a_type").html(event.a_type);
              ...
              $(".resend_btn").attr("data-id",event.a_id);
          },
  ...
  //$('.calendar2').fullCalendar('removeEvents');
    ...
    <div class="modal-content ">
      ...
      <div class="col-md-8">
        ...
        <div class="form-group col-md-12">
              <label class="col-md-3" for="email">Type</label>
              
              <div class="col-md-6 a_type">
        ...
        <div class="form-group col-md-12">
         ...
         <div class="col-md-4">
          <a href="javascript:void(0);" class="btn resch_btn pull-right btn-danger btn-xs">Reschedule</a><br><br>
          <a href="javascript:void(0);" data-id="" class="btn resend_btn pull-right btn-danger btn-xs">Re-send Email</a>
          <div class="reschedule_div hide">
            <div class="form-group col-md-12">
