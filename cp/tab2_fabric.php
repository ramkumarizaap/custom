...
if(!empty($_SESSION['shirt']['fabric']['fabric_id'])) {
  ...
  <?php } 
else if($_SESSION['p_dtl']['sub_cat_id']=='5')
{ 
                ...
                <div class="row">
                  <div class="col-xs-7">
                    <ul class="nav nav-tabs">
                      ...
                      <li class="active"><a href="#" class="tab" id="link_fabric">Fabric</a></li>
                      <li><a href="#" class="tab" id="link_extras">Accents</a></li>
                    </ul>
                    <div class="c-nav cf" id="fabric_form1">
                      <a href="javascript:;" class="next step_next btn btn-primary pull-right">NEXT STEP</a>
                      <a href="javascript:;" class="step_prev btn btn-default pull-right">PREVIOUS</a>
                      <span id="price_img" class="garment_price btn btn-danger pull-right"><small>$</small>
                        <?php echo floatval($_SESSION['p_dtl']['base_price']); ?>
                      </span>
                    </div>
                  </div>
                    ...
                    <div id="man_suit">
                      <form method="post" action="<?php echo $adminurl; ?>includes/action.php" id="fabric_form" class="configure_form test_C test_B">
                        ...
                        <div class="opt_box">
                          <div class="content suit" id="max_height_move">
                            <div class="col-md-6 pull-left">
                              <input type="text" data-list=".default_list5" class="search_fabric form-control" placeholder="Search fabric by name, cost or description">
                            </div><br><br><br>
                            <div class="instore_fab" style="<?php if(isset($_SESSION['coat']['fabric']['fabric_name']) && $_SESSION['coat']['fabric']['fabric_name']!='') { ?> display:block <?php } else { ?> display:none <?php } ?>">
                              <div class="col-md-6 pull-left">
                                <input type="text" class="form-control" name="instore_fabric" required value="<?php echo $_SESSION['coat']['fabric']['fabric_name']; ?>">
                                <span><strong>In Store Fabric Selection</strong> </span>
                              </div><br><br><br>
                            </div>
                            <div id="box_fabric_waistcoat">
                              <label>
                                <input type="checkbox" value="1" name="waistcoat_fabric"/>
                                <span>Choose a different fabric for the waistcoat</span>
                              </label>
                            </div>
                            <div class="box_opts">
                              <ul id="box_tab_suit_view" class="jacket">
                                <li class="jacket">
                                  <a id="tab_default_fabric" rel="default_fabric" href="javascript:;" class="jacket">
                                    <span>Jackets & pants fabric</span>
                                  </a>
                                </li><li class="waistcoat">
                                  <a class="waistcoat" rel="waistcoat" href="javascript:;">
                                    <span>Waistcoat fabric</span>
                                  </a>
                                </li>
                              </ul>
                              <div id="fabric_3d" class="test_C test_B">
                                <div id="preview_fabric_3d_common">
                                  <div class="info_fabric">
                                    ...
                                    <div class="left">
                                      <p id="fabric_name" class="big fab_name">
                                        <b><?php echo $_SESSION['fab_dtl']['fab_name']; ?></b>
                                      </p>
                                      <p id="second_row_info" class="fab_composition">
                                        <?php echo strip_tags($_SESSION['fab_dtl']['fab_desc']); ?> 
                                      </p>
                                  ...
                                  <div class="preview fab_img fabric_preview"> 
                                    ...
                                    <a class="view_fabric" href="#" data-toggle="modal" data-target="#<?php echo $_SESSION['fab_dtl']['fab_id']; ?>"></a>
                                  </div>
                                </div>
                                <div id="slider_fabrics">
                                  <!-- 1st fabric -->
                                  <input type="hidden" name="fabric_id"  value="<?php echo $_SESSION['fab_dtl']['fab_id']; ?>">
                                  <ul class="default_list5">
                                    <?php
                                      $fab=$site->get_fabrics1('1',$_SESSION['def_fab_id']);
                                      foreach ($fab as $key => $value)
                                      {
                                        ?>
                                            ...
                                            <div class="fabric_box suit_fabric_box fabric_box_3d">
                                              <div class="image suit_fabric fabric_thumb suit_fabric_<?php echo $fab[$key]['f_rand'];?> <?php if($_SESSION['fab_dtl']['fab_id']==$fab[$key]['f_rand']){?> selected <?php }?>" id="suit_fabric_141" rel="141" button_code="2" shoe_color="black">
                                                <a href="#" rel="<?php echo $fab[$key]['f_rand'];?>" rev="" extra="0" category="" thread_count="100 threads" shoe_color="black" button_code="2" brightness="normal" id_t4l_lining="57" id_t4l_lining_jacket="57" id_tie="3" slug="" class="select" ref="A04020X0" title="<?php echo $fab[$key]['fab_name'];?>" name="<?php echo $fab[$key]['fab_name'];?>" simplecomposition="WOOL" simple_composition="WOOL" composition="100% wool" rank="urban" btn_color="" fabric_weight="285" season="Year round">
                                                  <?php if($fab[$key]['fab_name']=='In-Store Fabric Selection') { ?>
                                                     <img alt="<?php echo $fab[$key]['fab_name'];?>" src="<?php echo $homeurl; ?>assets/dimg/fabric/instore_fab.jpg" class="b-lazy b-loaded">
                                                     <?php } else { ?>
                                                     <img alt="<?php echo $fab[$key]['fab_name'];?>" src="<?php echo $homeurl; ?>/assets/dimg/fabric/<?php echo $fab[$key]['f_rand'];?>_normal.jpg" class="b-lazy b-loaded">
                                                   <?php } ?>
                                                </a>
                                                <span class="info fabric-customclothies">
                                                  <div class="box_price fabrics_price">
                      ...
                      <script type="text/javascript">
                        ...
                        ready_callbacks.push(function()
                        {
                            Man_Coat.initCommon(default_fabric_id,'#fabric_form','#model_3d_preview',button_code,zipper_color,ribbon_color);
                            Man_Coat.initFabrics();
                        });  
                      </script>
                    </div>
                  </div>
