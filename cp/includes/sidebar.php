...
<li class="property <?=($uri1=='labels' || $uri1=='styles' || $uri1=='accents' || $uri1=='jacket_lining')?'active':'';?>">
            ...
            <ul class="treeview-menu">               
                 ...
                 <li class="styles <?=($uri1=='styles')?'active':'';?>"><a href="<?php echo $adminurl;?>styles/"><i class="fa fa-minus"></i> Styles</a></li>
                  <li class="accents <?=($uri1=='accents')?'active':'';?>"><a href="<?php echo $adminurl;?>accents/"><i class="fa fa-minus"></i> Accents</a></li>

                  <li class="jacket <?=($uri1=='jacket_lining')?'active':'';?>"><a href="<?php echo $adminurl;?>jacket_lining/"><i class="fa fa-minus"></i> Jacket Lining</a></li>
...
<!--
    ...
    <?php }?>
      ...
      <li class="appointment <?=($uri1=='appointment-list' || $uri1=='appointments' || $uri1=='showroom_template')?'active':'';?>"><a href="javascript:void(0);">
          <i class="fa fa-calendar"></i> <span>Appointments</span>
            ...
            <ul class="treeview-menu">               
                 ...
                 <li class="calendar <?=($uri1=='appointments')?'active':'';?>">
                  ...
                  <li class="calendar <?=($uri1=='showroom_template')?'active':'';?>">
                <a href="<?php echo $adminurl;?>showroom_template/"><i class="fa fa-minus"></i> Email Template</a>
               </li>
           </ul>
      </li>
<?php }?>
