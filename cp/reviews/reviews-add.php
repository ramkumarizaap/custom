...

{
...

    {
      ...
      $city=$rw[0]['city'];
      $date=date("m/d/y H:i:s",strtotime($rw[0]['created_date']));
...

    {
      ...
      $name="";$button="Save";$action="save";$id="1";$desc="";$img="";$date="";
                          ...
                          <div class="box-body">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control date-time" name="created_date" value="<?=$date;?>" placeholder="Enter Date">
