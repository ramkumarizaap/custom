    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                ...
                <div class="row">
                                        ...
                                        <select class="form-control color" name="product_color">
                                          ...
                                          $colors = array(
                                            ...
                                            foreach($colors as $item){
                                              ?>
                                            <option <?php if($p_color==$item){?> selected <?php }?>
                   ...
                   <div class="box box-success style_properties col-md-12">
                            ...
                            <div class="box-body style_div">
                              <?php
                                if($_GET['type'])
                                {
                                  include_once('ajax/get_edit_styles.php');
                                }
                                ?>
                            </div>
