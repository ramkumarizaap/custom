		...
		<div class="form-group <?php echo $p_label;?>">
		  ...
		  $sql21=mysqli_query($con,"select psd_value from property_style_details where psid=".$r11['ps_id']." and subcatid like '%4%'");
			...
			{	
				...
				$pant_class = $p_label."-".str_replace(array(" ","_"),"-",$psd_name1);
				?>
		  <label class="property-value <?php echo $pant_classa;?>" style="margin-left:10px;">
			  <div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative;">
...
<?php
	...
	{
		?>
		<script type="text/javascript" >property_suit();</script>
		<?php
	}
	else if($val=="2")
	{
		?>
		<script type="text/javascript" >property_shirt();</script>
		<?php
	}
	else if($val=="4")
	{
		?>
			<script type="text/javascript" >property_pant();</script>
		<?php
	}
	else if($val=="5")
	{
		?>
		<script type="text/javascript" >property_coat();</script>
		<?php
	}
	?>
