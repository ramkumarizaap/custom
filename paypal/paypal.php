...
<h1 class="paypal_text">Please Wait...Loading</h1>
    ...
    <input type="hidden" name="cancel_return" value="http://localhost/custom/paypal/cancel.php?oid=<?php echo $oid;?>&sid=<?php echo $sid;?>">
    <input type="hidden" name="return" value="http://localhost/custom/paypal/success.php?oid=<?php echo $oid;?>&sid=<?php echo $sid;?>">
