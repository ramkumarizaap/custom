                            ...
                            <div class="panel panel-default">
                              ...
                              <div id="collapse-002" class="panel-collapse collapse in">
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="filters-checkboxes myFilters" data-option-group="colors" data-option-type="filter">
                                    ...
                                    // $catid=isset($_GET['id']) ? str_replace("-","",$_GET['id']) : "";
                                     ...
                                     ?>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <label for="filters-categories-bags_and_purses" data-option-value=".<?php echo str_replace(array(" ","/"),"-",strtolower($value));?>" class="isotopeFilter margin-top">
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        ...
        <div id="isotopeContainer" class="shop-product-list isotope">
          ...
          <div class="isotope-item  <?php echo str_replace(array(" ","/"),"-",strtolower($value['p_color']));?> size1 size2 <?php echo str_replace(" ","-",strtolower($pro[$key]['sub_cat_name']));?>" data-date="January 1, 2012" data-popular="40" data-rating="<?php echo $score; ?>" data-price="<?php echo number_format($pro[$key]['price'],2);?>">
